---
layout: post
title: "Porous Media Theory: Summary for Coupled Problems in Science and Engineering"
date: 2021-04-14
tags: [porous media, geomechanics, continuum mechanics, coupled processes, THM]
excerpt: "The fundamental concepts and formulations in porous media theory are presented, covering volume fraction concept, conservation laws, thermodynamics, phase transitions, and coupled problem formulations for hydraulic, hydro-mechanical, and thermo-hydro-mechanical processes."
---
...
$$
\begin{equation}
\sum\limits_{\alpha=1}^{N} \left[ \rho^\alpha \frac{\mathrm{D}_\alpha s^\alpha}{\mathrm{D} t} - \sum_{\beta} M^{\beta \alpha} s^\alpha - \frac{1}{T^\alpha} \rho^\alpha h^\alpha + \nabla \cdot \left( \frac{1}{T^\alpha} \mathbf q^\alpha \right) \right] \geq 0.
\label{e:entropyineq}
\end{equation}
$$
